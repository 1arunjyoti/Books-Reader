    ...
    <>
      ...
      <div className="absolute top-16 right-0 bottom-0 w-80 bg-white/90 dark:bg-gray-900/90 backdrop-blur-xl border-l border-gray-200/50 dark:border-gray-700/50 shadow-2xl z-20 flex flex-col overflow-y-auto custom-scrollbar">
        ...
        <div className="flex-1 overflow-y-auto p-4 space-y-6">
          ...
          {/* Text Settings Group */}
          <div>
            <h3 className="text-xs font-semibold text-gray-400 dark:text-gray-500 uppercase tracking-wider mb-3 px-1">Text Settings</h3>
            <div className="space-y-2">
              <div className="flex items-center justify-between w-full py-2 px-3 bg-gray-50/50 dark:bg-gray-800/50 rounded-lg border border-gray-200/50 dark:border-gray-700/50">
                ...
                <span className="text-sm font-mono font-medium text-blue-600 dark:text-blue-400">{displayOptions.fontSize}%</span>
                <Button
                  variant="ghost"
                  size="sm"
              ...
              <div className="flex items-center justify-between w-full py-2 px-3 bg-gray-50/50 dark:bg-gray-800/50 rounded-lg border border-gray-200/50 dark:border-gray-700/50">
                ...
                <span className="text-sm font-mono font-medium text-blue-600 dark:text-blue-400">{displayOptions.lineHeight.toFixed(1)}</span>
                <Button
                  variant="ghost"
                  size="sm"
              ...
              >
                <div className="flex items-center">
                  <div className="p-2 rounded-lg bg-blue-50 dark:bg-blue-900/20 mr-3 group-hover:scale-110 transition-transform">
                    <Type className="h-4 w-4 text-blue-600 dark:text-blue-400" />
                  </div>
                  <span className="font-medium">Font: {displayOptions.fontFamily === 'serif' ? 'Serif' : 'Sans-serif'}</span>
                </div>
            ...
            <div className="space-y-2">
              ...
              >
                <div className="flex items-center">
                  ...
                  <span className="font-medium">{displayOptions.pageLayout === 'single' ? 'Single Page' : 'Double Page'}</span>
                </div>
                <ChevronRight className="h-4 w-4 text-gray-400" />
              </Button>
              <Button
              ...
              >
                <div className="flex items-center">
                  <div className="p-2 rounded-lg bg-pink-50 dark:bg-pink-900/20 mr-3 group-hover:scale-110 transition-transform">
                    <Paintbrush className="h-4 w-4 text-pink-600 dark:text-pink-400" />
                  </div>
                  <span className="font-medium">Theme: {displayOptions.colorFilter.charAt(0).toUpperCase() + displayOptions.colorFilter.slice(1)}</span>
                </div>
                <ChevronRight className="h-4 w-4 text-gray-400" />
              </Button>
              <div className="flex items-center justify-between w-full py-2 px-3 bg-gray-50/50 dark:bg-gray-800/50 rounded-lg border border-gray-200/50 dark:border-gray-700/50 mt-2">
                ...
                <span className="text-sm font-mono font-medium text-gray-600 dark:text-gray-300">{displayOptions.rotation}°</span>
          ...
          <div>
            ...
            <div className="space-y-2">
              ...
              >
                <div className={`p-2 rounded-lg mr-3 group-hover:scale-110 transition-transform ${
                  displayOptions.isFullscreen ? 'bg-gray-200 dark:bg-gray-700' : 'bg-gray-100 dark:bg-gray-800'
                }`}>
                  {displayOptions.isFullscreen ? (
                    <Minimize className={`h-4 w-4 ${displayOptions.isFullscreen ? 'text-gray-900 dark:text-gray-100' : 'text-gray-600 dark:text-gray-400'}`} />
                  ) : (
                    <Maximize className="h-4 w-4 text-gray-600 dark:text-gray-400" />
                  )}
                </div>
                <span className={`font-medium ${displayOptions.isFullscreen ? 'text-gray-900 dark:text-gray-100' : ''}`}>
                  {displayOptions.isFullscreen ? 'Exit Fullscreen' : 'Fullscreen'}
                </span>
              </Button>
            </div>
          </div>
