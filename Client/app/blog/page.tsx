...
export const metadata = {
  title: "Blog | BooksReader",
  description: "Insights, updates, and guides from the BooksReader team.",
};
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-8 lg:gap-12">
          {posts.map((post) => (
            ...
            >
              ...
              <div className={`h-64 w-full bg-gradient-to-br ${post.color || 'from-gray-500 to-gray-600'} relative overflow-hidden`}>
